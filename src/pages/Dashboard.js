...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6 fade-in">
      {/* Welcome Section */}
      <div className="bg-gradient-to-r from-red-600 to-red-800 dark:from-dark-orange dark:to-dark-orange-dark rounded-lg p-8 text-white">
        <div className="flex items-center space-x-4">
          <Shield className="w-12 h-12" />
          <div>
            <h1 className="text-3xl font-bold">Welcome to ARTEMIS</h1>
            <p className="text-red-100 dark:text-orange-100 mt-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        <Card className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{stats.totalDevices}</h3>
          <p className="text-gray-600 dark:text-gray-400">Total Devices</p>
        </Card>
        ...
        <Card className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{stats.routers}</h3>
          <p className="text-gray-600 dark:text-gray-400">Routers</p>
        </Card>
        ...
        <Card className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{stats.switches}</h3>
          <p className="text-gray-600 dark:text-gray-400">Switches</p>
        </Card>
        ...
        <Card className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{stats.firewalls}</h3>
          <p className="text-gray-600 dark:text-gray-400">Firewalls</p>
        </Card>
        ...
        <Card className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{stats.servers}</h3>
          <p className="text-gray-600 dark:text-gray-400">Servers</p>
        </Card>
      </div>
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {devices.slice(0, 5).map((device, index) => (
              <div key={index} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-dark-accent rounded-lg">
                <div className="flex items-center space-x-4">
                  <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center">
                    <Network className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-white">{device.devicename}</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">{device.ip} • {device.device_category}</p>
                  </div>
                </div>
